...
var App = function() {
    ...
    /* Demort start */
    var ajax_send = function(options){
        $.ajax({
            url: "/data/controllers",
            data: options,
            type: "POST",
            cache: false,
            dataType: 'json',
    ...
    $('body').on("click", '.exit-mw', function(){
    ...
    var dtIntegration = function() {
        $.extend(true, $.fn.dataTable.defaults, {
            "sDom": "<'row'<'col-sm-2 col-xs-3'l><'col-sm-10 col-xs-9 datatable-add-button'f>r>t<'row'<'col-sm-5 hidden-xs'i><'col-sm-7 col-xs-12 clearfix'p>>",
